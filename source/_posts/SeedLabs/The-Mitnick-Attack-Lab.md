...
![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/Qhrpbrj8FohhGGxvV6icE0AunWe.png)
...
![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/Lvnibq3YboUtFTx0bMScGxcbnsg.png)
...
![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/GJVibgD5joomJdx32tNcYC5snrh.png)
...
![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/ECwUbzWXToRWZYx2ZQEcjT2Zntd.png)

## Task 2: Spoof TCP Connections and rsh Sessions

如果无法预测序列号了，因此，我们允许嗅探数据包，用于获取序列号。

为了了解 rsh 的行为，我们从 TS 到 X 启动一个 rsh 会话，然后用 Wireshark 捕获它们之间的数据包。

![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/F5nibcscToN9StxnXVhcnF13nhh.png)
...
![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/OZn0bCnGioi4RjxxY10cnx1Anvh.png)

Wireshark 抓包结果如下，前三条是三次握手，第四第五发送 Romote Shell 数据并确定，接下来 TS 向 9090 发起第二次连接，没有回应，一直在重试。

![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/PRp8bldy6oLcy7xnaqZcKvCenDb.png)
...
![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/GXDzbGoY8owqoNxigsFcqD17nse.png)

Wireshark 截图，一切正常。

![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/QmUZbaJ2XopbGlx80c3cpoUZnYc.png)
...
![](https://ceyewan.oss-cn-beijing.aliyuncs.com/typora/U456bakZWohyEqxuJDPcpUldn4K.png)
